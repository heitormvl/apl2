...
public class MainApl2 {
	...
	public static void main(String[] args) throws FileNotFoundException, IOException {
        ...
        String stringDadosLegados = null;
        try {
            stringDadosLegados = Data.loadTextFileToString("C:\\Users\\heito\\OneDrive\\Documentos\\Mackenzie\\Estrutura de dados\\apl2\\src\\dados.txt");  
        }
        ...
        String[] linhasDadosLegados = stringDadosLegados.split("\n");
        
        for (int i = 0; i < linhasDadosLegados.length; i++) {
            String[] valoresAluno = linhasDadosLegados[i].split("#");
            list.insert(Integer.parseInt(valoresAluno[0]), valoresAluno[1], Integer.parseInt(valoresAluno[2]), Integer.parseInt(valoresAluno[3]));
        }
