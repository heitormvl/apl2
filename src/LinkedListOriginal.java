public class LinkedListOriginal {
    ...
    public NodeOriginal removeNode(int id) {
        ...
        previous.setNext(toRemove.getNext()); // O próximo nó do nó anterior ao nó a ser removido
                                              // passa a ser o próximo nó do nó a ser removido
        --count; // Decrementa o contador de elementos
    ...
    public NodeOriginal getHead() { return head; }

    // Retorna o último elemento da lista
    public NodeOriginal getTail() { return tail; }
